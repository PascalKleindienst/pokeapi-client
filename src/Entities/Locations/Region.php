...
final class Region extends Entity
{
    ...
    public function __construct(
        ...
        /** @var ApiResourceCollection<Location> $locations A list of locations that can be found in this region. */
        #[Field(FieldType::NAMED_API_RESOURCE_LIST, definition: Location::class)]
        public ApiResourceCollection $locations,

        /** @var Collection<Name> $names The name of this resource listed in different languages. */
        #[Field(FieldType::TRANSLATION, definition: Name::class)]
        public Collection $names,

        /** @var Generation|null $mainGeneration The generation this region was introduced in. */
        #[Field(FieldType::NAMED_API_RESOURCE, apiName: 'main_generation', definition: Generation::class)]
        public Generation|null $mainGeneration,

        /** @var ApiResourceCollection<Pokedex> $pokedexes A list of pokédexes that catalogue Pokémon in this region. */
        #[Field(FieldType::NAMED_API_RESOURCE_LIST, definition: Pokedex::class)]
        public ApiResourceCollection $pokedexes,

        /** @var ApiResourceCollection<VersionGroup> $versionGroups A list of version groups where this region can be visited. */
