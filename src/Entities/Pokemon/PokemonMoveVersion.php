 ...
 */
final class PokemonMoveVersion extends Entity
{
    /**
    ...
    public function __construct(
        /** @var MoveLearnMethod $moveLearnMethod The method by which the move is learned. */
        ...
        /** @var VersionGroup $versionGroup The version group in which the move is learned. */
