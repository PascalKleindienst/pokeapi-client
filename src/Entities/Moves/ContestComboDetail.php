 ...
 */
final class ContestComboDetail extends Entity
{
    /**
    ...
    public function __construct(
        /** @var Move|null $useBefore A list of moves to use before this move. */
        #[Field(FieldType::NAMED_API_RESOURCE, apiName: 'use_before', definition: Move::class)]
        public Move|null $useBefore,

        /** @var Move|null $useAfter A list of moves to use after this move. */
        #[Field(FieldType::NAMED_API_RESOURCE, apiName: 'use_after', definition: Move::class)]
        public Move|null $useAfter,
    ) {
    }
}
