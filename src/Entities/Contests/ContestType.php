...
final class ContestType extends Entity
{
    /**
    ...
    public function __construct(
        ...
        /** @var BerryFlavor $berryFlavor The berry flavor that correlates with this contest type. */
        #[Field(FieldType::NAMED_API_RESOURCE, 'berry_flavor', definition: BerryFlavor::class)]
        public BerryFlavor $berryFlavor,
