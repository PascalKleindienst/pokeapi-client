...
final class EvolutionChain extends Entity
{
    /**
    ...
    public function __construct(
        ...
        /** @var Item|null $babyTriggerItem The item that a Pokémon would be holding when mating that would trigger the egg hatching a baby Pokémon rather than a basic Pokémon. */
        #[Field(FieldType::NAMED_API_RESOURCE, apiName: 'baby_trigger_item', definition: Item::class)]
        public Item|null $babyTriggerItem,
